...
A changed image isn't "binary file changed" here: it opens as a before/after picture with a divider you drag across it, and the header picker switches every picture in the review to side-by-side, cross-fade, or pixel-difference — comment on it like any line.
